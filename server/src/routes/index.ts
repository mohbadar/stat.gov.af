...
export function init(app: express.Application): void {
    ...
    /**
     * @description
     *  Forwards any requests to the /api/users URI to our UserRouter
    ...
    app.use('/node-api/queries', jwtConfig.isAuthenticated, QueryRouter);
        ...
        /**
     * @description
     *  Forwards any requests to the /api/widgets URI to our WidgetRouter
     *  Also, check if user authenticated
     * @constructs
     */
     ...
     * @constructs
     */
    app.use('/node-api/auth', AuthRouter);
