...
const ALL_VALUES = '*';
const NONE_VALUES = '-';
const QueryResultUrl = 'api/public/query_results/';
const JobUlr = 'api/public/jobs/';
const statuses = {
    1: 'waiting',
    2: 'processing',
    3: 'done',
...
export class QueryResultService {
    ...
    //     let link = `api/public/queries/${queryId}/results/${this.getId()}.${fileType}`;
    //     if (apiKey) {
