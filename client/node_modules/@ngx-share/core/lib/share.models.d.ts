...
export interface IShareButton {
    ...
    create?: (prop: IShareButton, url: () => string, http: HttpClient, platform: Platform, document: Document, windowSize: string, disableButton: (disable: boolean) => void, logger: (text: string) => void) => ShareButtonBase;
    /** Share button text */
    text?: string;
